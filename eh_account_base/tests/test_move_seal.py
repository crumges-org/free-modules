...
class TestMoveSeal(EhAccountIntegrationTestCase):
    ...
    def setUpClass(cls):
        ...
        migration_path = (
            ...
            / 'migrations' / '17.0.1.7.4' / 'post-migration.py'
        )
        ...
        migration_path = (
            Path(__file__).parents[1]
            / 'migrations' / '17.0.1.7.5' / 'post-migration.py'
        )
        spec = spec_from_file_location(
        ...
        migration_path = (
            Path(__file__).parents[1]
            / 'migrations' / '17.0.1.7.6' / 'post-migration.py'
        )
        spec = spec_from_file_location(
        ...
        migration_path = (
            Path(__file__).parents[1]
            / 'migrations' / '17.0.1.7.8' / 'post-migration.py'
        )
        spec = spec_from_file_location(
    ...
    def test_178_migration_repairs_stored_source_projections(self):
        ...
        self.migration_178.migrate(self.env.cr, '17.0.1.7.7')
    ...
    def test_legacy_rpc_writable_seal_is_frozen_but_never_trusted(self):
        ...
        self.migration_174.migrate(self.env.cr, '17.0.1.7.3')
        self.env.invalidate_all()
    ...
    def test_175_upgrade_quarantines_old_unsealed_reversal_graph(self):
        ...
        self.env.flush_all()
        self.migration_175.migrate(self.env.cr, '17.0.1.7.4')
        self.env.invalidate_all()
    ...
    def test_176_upgrade_quarantines_legacy_portal_send_and_pdf_evidence(self):
        ...
        self.migration_176.migrate(self.env.cr, '17.0.1.7.5')
        self.env.invalidate_all()
